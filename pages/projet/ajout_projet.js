...
const FormLayoutDemo = () => {
    ...
    useEffect(() => {
        console.log('images use effect', images);
    }, [images]);
    const types = [
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (images.length !== 0 && titre !== '' && adresse !== '' && description !== '' && productionAnuelle !== '' && type !== null && video !== null) {
                const response = await fetch('http://51.75.207.131:5050/projet/ajouter_projet', {
                    method: 'POST',
                    body: formData,
                    credentials: 'include'
                });
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="p-fluid formgrid grid">
                            ...
                            <div className="field col-12 ">
                                ...
                                <InputText onChange={(e) => setVideo(e.target.value)} id="video" name="video" type="text" />
                                ...
                                {/* <FileUpload
                                    ...
                                    chooseLabel={video ? video.name : 'Choisir une video'}
                                    cancelLabel="Cancel"
                                    mode="basic"
                                    accept="video/*"
                                    maxFileSize={1000000}
